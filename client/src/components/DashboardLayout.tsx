 ...
 * Roxo LabIA (#7C3AED) como primária, laranja (#F97316) como acento
 */
import { useState } from "react";
import { Link, useLocation } from "wouter";
import {
  LayoutDashboard, Route, Target, Users, School, BarChart3, Settings,
  ChevronLeft, ChevronRight, LogOut, Bell, Search, Menu, X, Rocket
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Trilhas", icon: Route, path: "/trilhas" },
  { label: "Missões", icon: Target, path: "/missoes" },
  { label: "Alunos", icon: Users, path: "/alunos" },
  { label: "Escolas", icon: School, path: "/escolas" },
              ...
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-muted/50 transition-colors">
                  ...
                  <div className="hidden md:block text-left">
                    <p className="text-sm font-medium leading-tight">Fabíola</p>
                    <p className="text-[11px] text-muted-foreground leading-tight">Administradora</p>
                  </div>
                </button>
              </DropdownMenuTrigger>
